...
//        return entities.stream() Stream<ingresso>
//                .map (entity -> toDto(entity)) Stream<IngressoDto>
//                .collect (Collectors.toList());
//    }
//
//    public static IngressoDto toDto(final Ingresso Entity) {
//        if (Object.nonNull(entity)) {
...
//    }
//
//    public static void copy(final Venda source, final Venda destiny) {
